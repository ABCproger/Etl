...
namespace Simple_ETL_Project.Migrations
{
    ...
    [Migration("20241227011415_AddIndexesToTripDatasTable")]
    partial class AddIndexesToTripDatasTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Simple_ETL_Project.Database.Entities.TripData", b =>
                {
                    ...
                    b.HasIndex("PuLocationId")
                        .HasDatabaseName("ix_pulocation_id");

                    b.HasIndex("TripDistance")
                        .HasDatabaseName("ix_trip_distance");

                    b.HasIndex("TrepPickUpDateTime", "TrepDropOffDateTime")
